...
if __name__ == "__main__":
    ...
    def fetch_arg_long_short_default(
        longname, shortname, default_value, typecasting_func=int
    ):
        if fetch_arg("-" + shortname) != None:
            ...
            if comm_world.rank == 0:
                print(
                    "arg not found:", longname, "; using default value:", default_value
                )
    ...
    if comm_world.rank == 0:
        print(
            ...
            sum([atom_type.numatoms for atom_type in crystal.l_atoms]),
        )
