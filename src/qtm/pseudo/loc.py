...
def loc_generate_rhoatomic(sp: BasisAtoms, grho: GSpace) -> FieldG:
    ...
    if sp.ppdata is None:
        raise ValueError("'sp' has pseudopotential data 'ppdata' set to None")
...
def loc_generate_pot_rhocore(sp: BasisAtoms, grho: GSpace) -> (FieldG, FieldG):
    ...
    v_ion = FieldG.empty(grho, 1)
    rho_core = FieldG.empty(grho, 1)
