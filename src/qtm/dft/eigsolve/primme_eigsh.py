...
def solve(
    ...
    with kgrp_intra as comm:
        ...
        Prec_oper = LinearOperator(
            shape=(kswfn.gkspc.size_g, kswfn.gkspc.size_g),
            dtype=np.complex128,
            matvec=preconditioner,
            rmatvec=preconditioner,
            matmat=preconditioner,
            rmatmat=preconditioner,
        )
