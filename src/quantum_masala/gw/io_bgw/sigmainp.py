...
class Sigmainp():
    ...
    def __init__(self):
        ...
        """
        self.frequency_grid_shift : int = None
        ...
        *   2 if you want to center the frequency grid around each mean-field QP energy (default)
        """
        self.delta_frequency_eval : float = None
        """"""
        self.max_frequency_eval : float = None
        """"""
        self.init_frequency_eval : float = None
        ...
        """
        self.number_frequency_eval : int = None
        ...
        """
        self.finite_difference_form : int = None
        ...
        *   default = 2 : forward for diagonal and none for off-diagonal
        """
        self.finite_difference_spacing : float = None
        ...
        *   `ec_cor = ec_in + ecs + ecdel * (ec_in - ec0)`
        ...
        ### Misc. parameters
        """
        self.screened_coulomb_cutoff : float = None
        ...
        """
        self.bare_coulomb_cutoff : float = None
        ...
        """
        self.spin_index_min : int = None
        """"""
        self.spin_index_max : int = None
        """"""
        self.cell_average_cutoff : float = None
        ...
        *   Set to 3 for the Generalized Plasmon Pole model in the Godby-Needs flavor. Note: does not work with parallelization in frequencies.
        ...
        """
        self.cd_integration_method : int = None
        ...
        *   3 for cubic Hermite matrix elements over each integration segment
        """
        self.invalid_gpp_mode : int = None
        ...
        """
        self.full_ch_conv_log : int = None
        ...
        *   1 to log the real and imag. parts of all bands for which we compute Sigma.
        """
        self.bare_exchange_fraction : float = None
        ...
        """
        self.gpp_broadening : float = None
        ...
        *   6: max - only use if instructed to, severe performance downgrade. Note that verbosity levels are cumulative. Most users will want to stick with level 1 and, at most, level 3. Only use level 4+ if debugging the code.
        """
        self.evs_outer : float = None
        """"""
        self.ev0_outer : float = None
        """"""
        self.evdel_outer : float = None
        """"""
        self.ecs_outer : float = None
        """"""
        self.ec0_outer : float = None
        """"""
        self.ecdel_outer : float = None
        """"""
        self.cvfit_outer : List[int] = None
        ...
        """
        self.do_sigma_subspace : bool = False
        ...
        """
        self.eqp_outer_corrections : bool = False
        ...
        """
        self.tol_degeneracy : bool = False
        ...
        """
        self.no_symmetries_q_grid : bool = False
        """"""
        self.use_symmetries_q_grid : bool = False
        """"""
        self.dont_symmetrize : bool = False
        ...
        """
        self.no_symmetries_offdiagonals : bool = False
        ...
        """
        self.die_outside_sphere : bool = False
        """"""
        self.ignore_outside_sphere : bool = False
        """"""
        self.skip_averagew : bool = False
