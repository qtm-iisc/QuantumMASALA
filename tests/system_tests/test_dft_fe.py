...
# Atom Basis
fe_oncv = UPFv2Data.from_file(os.path.join(os.path.dirname(__file__),'Fe_ONCV_PBE-1.2.upf'))
...
def test_energy():
    global en
    ref_en = EnergyData(total=-108.7572322013999, hwf=-108.7572322013999, one_el=-19.103027941169813, ewald=-91.21243030617246, hartree=11.995053402940044, xc=-10.436472791329699, fermi=1.1520059066614938, smear=-0.00035456566796903066, internal=-108.75687763573194, HO_level=None, LU_level=None)
...
def test_eigenvalues():
    ...
    ref_eigenvalues = np.array([[-1.57529711,  0.57049308,  1.05557754,  1.94060137],
    ...
    assert np.allclose(np.array([wfn[0].evl[1::3] for wfn in l_wfn_kgrp[::7]]), ref_eigenvalues, atol=1e-3)
    

def test_density():
    global rho
    basis_size = 531
    cryst_40 = np.array([[ 0, -2, -1,  2,  1,  3, -1, -2, -3, -5,  1,  1,  1, -2],
       [ 0,  0,  1,  1,  2,  2,  3,  4, -4, -3, -2, -2, -1, -1],
       [ 0,  5,  0, -3,  2, -1,  4,  3,  1,  2,  0, -3,  2, -2]])
    norm2_40 = np.array([ 0.        , 57.51903849,  9.08195345, 27.24586034, 15.13658908,
       21.19122471, 39.3551316 , 57.51903849, 45.40976723, 57.51903849,
       21.19122471, 21.19122471, 33.30049597, 27.24586034])
    data_40 = np.array([[ 2.13106827e+02-1.70798383e-17j, -4.24495971e-03+9.97537527e-19j,
         1.02073312e+01-1.17065197e-18j, -1.36653492e+00+5.46288830e-18j,
        -7.41852369e-01+5.63136506e-18j, -2.26777981e+00+6.85587460e-18j,
        -3.73153157e-01-1.88506238e-18j,  1.46497267e-03+1.17228634e-18j,
        -8.99304945e-02+3.75860086e-18j, -4.24495971e-03+9.97537527e-19j,
        -2.26777981e+00+6.85587460e-18j, -2.26777981e+00+6.85587460e-18j,
        -1.10652402e+00-2.36182338e-18j, -1.36653492e+00+5.46288830e-18j],
       [ 2.02034666e+02+1.70798383e-17j, -4.43759610e-03+2.95861336e-18j,
         1.18161765e+01+6.46300704e-18j, -1.89454052e+00-1.18628421e-18j,
        -1.16823591e+00+2.88782960e-18j, -1.78510624e+00+5.15961325e-18j,
        -4.07157311e-01+1.01703969e-18j,  1.22450174e-03+3.89539635e-18j,
        -1.52288453e-01+9.23947342e-18j, -4.43759610e-03+2.95861336e-18j,
        -1.78510624e+00+5.15961325e-18j, -1.78510624e+00+5.15961325e-18j,
        -9.60904137e-01+2.57076685e-19j, -1.89454052e+00-1.18628421e-18j]])
